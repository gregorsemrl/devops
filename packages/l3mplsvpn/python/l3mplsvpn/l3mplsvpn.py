...
from custom_allocator import custom_id_allocator
...
class ServiceCallbacks(Service):
    ...
    def cb_create(self, tctx, root, service, proplist):
        ...
        custom_id_allocator.id_request(service._path, root)
        vpn_id = custom_id_allocator.id_read(tctx, service._path)
        if vpn_id is None:
